  ...
  return (
    <>
      <style>{`
        ...
        .animate-next-card {
          animation: fade-slide-up 150ms ease-out forwards;
        }
      `}</style>

      {/* The key prop forces React to remount the div and re-trigger the animation every time the question changes */}
      <div key={current.question_id} className="animate-next-card mt-6 rounded-lg border border-line bg-card p-6 shadow-sm">
