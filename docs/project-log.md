...
| 2026-05-15 | Weekly sync with Spencer - reviewed progress and next steps                                                | 1.0   |
...
| 2026-05-15 | Weekly sync with Enosh - reviewed progress and next steps                                                  | 1.0   |
...
| Date       | Task                                                                                                      | Hours |
|------------|-----------------------------------------------------------------------------------------------------------|-------|
| 2026-05-24 | Weekly sync with Enosh - reviewed progress and next steps                                                  | 1.0   |
| 2026-05-25 | Reviewed Orbital programme overview requirements for Milestone 1; planned week 2 task split with Enosh   | 1.0   |
| 2026-05-26 | Built the signup page with email and password form; connected to Supabase auth signup; debugged merge conflict caused by overlapping work on the same branch; resolved conflict and opened PR | 5.0   |
...
| 2026-05-27 | Built auth middleware to protect routes - unauthenticated users are sent to login, logged-in users are redirected away from signup and login pages; updated root page to redirect based on login state; opened and merged PR | 4.0   |
...
| 2026-05-31 | Weekly sync with Enosh - reviewed progress and next steps                                                  | 1.0   |
...
| 2026-05-22 | Created three Supabase client files (client.ts, server.ts, middleware.ts); created .env.local with Supabase keys; fixed Supabase packages that were installed in the wrong folder; debugged Vercel deployment being blocked due to a typo in git email address; added environment variables to Vercel dashboard; confirmed live URL was working | 2.0   |
...
| 2026-05-24 | Weekly sync with Spencer - reviewed progress and next steps                                                | 1.0   |
...
| 2026-05-26 | Built the login page with email and password form connected to Supabase sign in; debugged email not confirmed error by turning off email confirmation in Supabase dashboard; tested login flow with a real account | 4.0   |
| 2026-05-27 | Built the dashboard page showing the logged-in user's email address; built a logout button as a separate client component; pulled Spencer's merged middleware to get route protection working; tested the full flow - signup, login, dashboard, logout; opened and merged PR | 4.0   |
| 2026-05-28 | Wrote README sections 8-15 covering system design, tech stack, development plan, software engineering practices, proof of concept screenshots, setup instructions, known limitations, and acknowledgements; drew architecture and page flow diagrams in Excalidraw; took screenshots of all four POC screens; pushed directly to main by mistake | 3.5   |
...
| 2026-05-31 | Weekly sync with Spencer - reviewed progress and next steps                                                | 1.0   |
| **Total**  |                                                                                                           | **30.5** |
...
| 2026-06-07 | Weekly sync with Enosh - reviewed progress and next steps | 1.0 |
| 2026-06-08 | Ideated week-by-week task breakdown with Enosh, mandatory vs optional deliverables, role split | 1.5 |
...
| 2026-06-14 | Weekly sync with Enosh - reviewed progress and next steps | 1.0 |
...
| 2026-06-17 | Built the read-only module detail page showing the topics list for a given module | 2.0 |
...
| 2026-06-20 | Reviewed and merged Enosh's icon/logo styling, markdown import, and recommender/weak-topics pull requests; tested on the Vercel preview URL | 1.5 |
...
| 2026-06-21 | Built a quiz-taking UI component for the topic quiz flow; worked with Enosh to consolidate it with his QuizRunner component during integration, so the quiz page shipped on a single shared implementation | 3.0 |
| 2026-06-21 | Reviewed and merged Enosh's unit test, quiz-taking UI, score-breakdown, and bug-fix pull requests; tested on the Vercel preview URL | 2.0 |
| 2026-06-21 | Pre-deadline sync with Enosh - reviewed outstanding M2 tasks and progress against the 29 Jun deadline | 2.0 |
...
| 2026-06-23 | Executed manual system testing; documented 25+ test cases with screenshots in the manual test log | 6.0 |
| 2026-06-23 | Reviewed and merged Enosh's ER diagram and redrawn architecture/page-flow diagram pull requests | 0.5 |
| 2026-06-26 | Distributed the user testing form to two NUS student testers and coordinated their asynchronous remote testing sessions; collected completed responses for Enosh to synthesise | 3.0 |
| 2026-06-26 | Reviewed and merged Enosh's test-screenshot and click-affordance pull requests; tested navigation fixes on the Vercel preview URL | 1.0 |
| 2026-06-27 | Took M2 screenshots of all core feature pages (modules list, module detail, topic detail, quiz answer, quiz results, dashboard); committed 6 screenshots to the repo | 1.0 |
| 2026-06-27 | Reviewed and merged Enosh's M2 screenshots, README finalisation, and project log pull requests | 1.0 |
| 2026-06-28 | Built and recorded Milestone 2 video; wrote full voiceover script covering all features and live demo | 6.0 |
| 2026-06-28 | Pre-deadline sync with Enosh - final check before Milestone 2 submission | 3.0 |
| **Total**  |                                                                                                           | **81.0** |
...
| Date       | Task                                                                                                      | Hours |
|------------|-----------------------------------------------------------------------------------------------------------|-------|
| 2026-06-07 | Weekly sync with Spencer - reviewed progress and next steps | 1.0 |
...
| 2026-06-08 | Ran M2 schema migration in Supabase SQL editor; created all 7 tables, RLS policies, triggers, cascade deletes; debugged idempotency issues; verified auth trigger creates profile rows on signup | 2.0 |
...
| 2026-06-09 | Debugged seed data script - null user_id error traced to a missing profiles row from signing up before the profile-creation trigger existed; fixed with manual insert; saved the cleaned script to the repo | 1.5 |
| 2026-06-09 | Worked out a file ownership matrix to prevent merge conflicts | 0.5 |
| 2026-06-14 | Weekly sync with Spencer - reviewed progress and next steps | 1.0 |
...
| 2026-06-16 | Built Supabase Storage setup - private notes-files bucket, RLS policies, storage helper library; smoke-tested upload via Supabase dashboard | 2.5 |
| 2026-06-16 | Subtopic create, edit, and delete server actions following the same nested-resource pattern | 2.5 |
...
| 2026-06-17 | Merged main into the in-progress storage setup and subtopics actions branches; reran lint and build | 1.5 |
| 2026-06-17 | Wrote the create-question server action - MCQ option parsing, answer-matching validation, difficulty check | 3.0 |
...
| 2026-06-18 | Built a shared nav bar so the modules page is reachable from the dashboard; wired into the root layout; fixed the logout button import (was a default export, not named); removed a duplicate logout button from the dashboard page; installed Homebrew and GitHub CLI for the pull request workflow | 3.0 |
| 2026-06-18 | Designed NoteFlow logo/icon - explored five initial concept directions in SVG; narrowed to two, then converged on a "Flowing Note" concept (page with folded corner, header lines, wave as horizon line, rising graph line with data dots, loop arrow); iterated colour from teal to cream | 3.0 |
...
| 2026-06-18 | Created the decisions log document to record major decisions across Liftoff, M1 and M2 (stack switch, Apollo 11 scope, schema choices, storage conventions, scaffold patterns, quiz grading, weak-topic thresholds, recommender weights) | 2.5 |
...
| 2026-06-21 | Pre-deadline sync with Spencer - reviewed outstanding M2 tasks and progress against the 29 Jun deadline | 2.0 |
...
| 2026-06-24 | Code comments audit on the quiz, import, storage, and questions files; resolved a stale TODO comment in the create-module action; committed and opened a pull request | 2.5 |
| 2026-06-24 | Bug triage from Spencer's manual testing findings: sorted into real bugs, UX-only notes, and M3-scope items; documented in the bug triage log | 2.0 |
...
| 2026-06-28 | Pre-deadline sync with Spencer - final check before Milestone 2 submission | 3.0 |
| **Total**  |                                                                                                           | **99.0** |
...
| Date       | Task                                                                                                      | Hours |
|------------|-----------------------------------------------------------------------------------------------------------|-------|
| 2026-07-05 | Weekly sync with Enosh - reviewed progress and next steps | 1.0   |
| 2026-07-09 | Reviewed and merged Enosh's error-handling, design-token/theme-toggle, seed-dataset, spaced-repetition, and demo-login pull requests; tested on the Vercel preview URL | 3.0   |
| 2026-07-11 | Reviewed and merged Enosh's concept graph and AI question generation pull requests; tested the graph UI and generation flow on the Vercel preview URL | 3.0   |
| 2026-07-12 | Weekly sync with Enosh - reviewed progress and next steps | 1.0   |
| 2026-07-13 | Reviewed and merged Enosh's visual design system pull request (paper-physics shadows, ruled surfaces, and the token migration across roughly 25 pages) | 1.5   |
| 2026-07-16 | Reviewed and merged Enosh's CI workflow, demo-account reseeding, and manual-test-log documentation pull requests | 1.5   |
| 2026-07-17 | Recruited and coordinated five external testers (NUS, NTU, secondary, and NUS-grad) for the Milestone 3 asynchronous remote user testing round; distributed the "Try it yourself" task sheet and collected completed responses | 5.0   |
| 2026-07-19 | Reviewed and merged Enosh's bug-fix, demo-reset, GEA1000, and README pull requests; verified fixes on the live deployment | 2.5   |
| 2026-07-19 | Pre-deadline sync with Enosh - reviewed outstanding M3 tasks and progress against the 27 Jul deadline | 2.0   |
| 2026-07-20 | Converted remaining hardcoded colours to design tokens and did a dark-mode contrast pass across the dashboard, error page, nav bar, nav links, and zoom components; made a same-day follow-up one-line dashboard tweak; opened and merged PR | 2.0   |
| 2026-07-20 | Built empty states for all list views and loading skeletons for data-heavy routes across the dashboard, modules, module detail, concept graph, and review pages; added reusable empty-state and skeleton-loading components; opened and merged PR | 3.5   |
| 2026-07-21 | Built dashboard onboarding getting-started checklist; mounted a breadcrumbs component across all sub-pages for UX wayfinding; implemented active navigation link states; completed dark mode token sweep on auth forms; opened and merged PR | 5.0   |
| 2026-07-22 | Executed app-wide copy consistency sweep; rewrote the review session with verb-first grading buttons ("Mark correct"/"Mark incorrect") and an actionable completion state; updated concept graph mastery terminology and hover card copy | 4.0   |
| 2026-07-23 | Polished the AI question generation panel copy and error states; replaced bare loading spinner with a semantic skeleton loading state and pulsing status text; made error banners actionable with dismiss buttons | 3.5   |
| 2026-07-24 | Debugged and manually resolved Git merge conflicts between main and the copy-sweep branch in VS Code; verified changes and pushed clean commit; opened and merged PR | 1.5   |
| 2026-07-24 | Reviewed and merged Enosh's Gemini fallback and dashboard score-breakdown link pull requests | 1.0   |
| 2026-07-25 | Built final feature UI refinements; adjusted navigation bar due-review badge dark mode contrast; added a 150ms slide-and-fade CSS animation to the review session queue; opened and merged PR | 3.0   |
| 2026-07-25 | Built and recorded the Milestone 3 video; recorded live app demo footage; wrote and recorded voiceover; edited in CapCut - synced live demo footage to slides, added captions and transitions; exported final MP4| 12.0  |
| 2026-07-25 | Pre-deadline sync with Enosh - final check before Milestone 3 submission | 3.0   |
| **Total**  |                                                                                                           | **59.0** |
...
| Date       | Task                                                                                                      | Hours |
|------------|-----------------------------------------------------------------------------------------------------------|-------|
| 2026-07-05 | Weekly sync with Spencer - reviewed progress and next steps | 1.0 |
...
| 2026-07-07 | Added design elements to the global stylesheet (light/dark pairs), built a mastery-indicator component, and added a dark/light theme toggle; wired into dashboard, layout, and nav bar | 3.0 |
| 2026-07-08 | Reproduced M2 evaluator crash reports on a fresh account; queried for orphaned profile rows, found 4 affected, backfilled via insert; confirmed root cause was accounts created before the profile-creation trigger existed; documented in the decisions log | 1.0 |
...
| 2026-07-10 | Rewrote the graph view as a dynamic canvas - zoom, fit-to-view, live physics with drag ripple, prerequisite-chain hover highlighting, a hover card showing accuracy/attempts/blocked reason, a click-to-jump minimap, and curved edges | 2.5 |
| 2026-07-11 | Built the AI question generation helper library; wrote 46 boundary and edge-case tests | 2.5 |
...
| 2026-07-12 | Visual language pass - paper-physics shadows, ruled surfaces, and a type hierarchy across around 25 page files; completed the remaining hardcoded-colour-to-token migration; merged the latest changes from main into the branch, resolving conflicts across 16 files; opened and merged the pull request | 3.0 |
| 2026-07-12 | Weekly sync with Spencer - reviewed progress and next steps | 1.0 |
...
| 2026-07-18 | README pass for Milestone 3 submission; captured and renamed the outstanding M2/M3 screenshots to match the README's figure references | 2.5 |
...
| 2026-07-19 | Pre-deadline sync with Spencer - reviewed outstanding M3 tasks and progress against the 27 Jul deadline | 2.0 |
| 2026-07-20 | Built the Milestone 3 poster - laid out architecture, dashboard, concept graph, and AI generation panels with a QR code linking to the live demo and repo; exported print-resolution and preview versions | 4.0 |
| 2026-07-24 | Discovered a Gemini 3.5-flash outage and added a timeout plus fallback to gemini-3.1-flash-lite; regenerated the ER diagram with the missing M3 tables; redrew the poster's page-flow diagram; added an in-app link to the recommendation score-breakdown view | 3.5 |
| 2026-07-25 | Pre-deadline sync with Spencer - final check before Milestone 3 submission | 3.0 |
| **Total**  |                                                                                                           | **77.0** |
...
|------------------|-----------------|-----------------|---------------|----------|
| Liftoff          | 18 May 2pm SGT  | 11.5            | 12.5          | 24.0     |
| Milestone 1      | 1 Jun 2pm SGT   | 19.0            | 30.5          | 49.5     |
| Milestone 2      | 29 Jun 2pm SGT  | 81.0            | 99.0          | 180.0    |
| Milestone 3      | 27 Jul 2pm SGT  | 59.0            | 77.0          | 136.0    |
| Splashdown       | 26 Aug          | 0.0             | 0.0           | 0.0      |
| **Running Total**|                 | **170.5**       | **219.0**     | **389.5**|
